...
### 本指南中的实例
本指南包含了大量实例——包括各种Shell命令的实例和用C/C++以及Golang编写的一些完整的程序，能够帮你节省上百度找代码抄的时间。本指南以及实例的代码托管在Github上，链接在[这里](https://github.com/chfanghr/linux-guide)^2^，你可以使用git或网页获得它们，并自由使用，详见[License](LICENSE)。
